#!/bin/bash
 ...
 UNMARK(){ $e "\e[27m";}
  ...
  ARROW(){ IFS= read -s -n1 key 2>/dev/null >&2
     ...
     M0(){ TPUT  4 20; $e "1)Install Idena-manager";}
     M1(){ TPUT  5 20; $e "2)Node Management";}
	 M2(){ TPUT  6 20; $e "3)Uninstall Idena-manager";}
...
REFRESH(){ after=$((i+1)); before=$((i-1))
  ...
  while [[ "$O" != " " ]]; do case $i in
        0) S=M0;SC;if [[ $cur == enter ]];then R;reset && bash /home/idena-aio/idena-manager/install-idenamanager.sh ;fi;;
